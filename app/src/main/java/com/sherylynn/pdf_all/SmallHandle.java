...
public class SmallHandle extends RelativeLayout implements ScrollHandle {
    ...
    private final static int delayMillis = 1500 ;
    ...
    public SmallHandle(Context context) {
        this(context, false);
    }

    public SmallHandle(Context context, boolean inverted) {
        super(context);
    ...
    public void hideDelayed() {
        handler.postDelayed(hidePageScrollerRunnable, delayMillis);
    }
